...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-wynis8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-wynis8.containers.anotherwebservice.com/
...
```
git clone git@github.com:dev-760/container-wynis8.git
cd container-wynis8
```
...
```
docker attach container-wynis8
```
